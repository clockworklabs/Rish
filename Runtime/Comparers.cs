...
namespace RishUI
{
    ...
    public class ComparerAttribute : PreserveAttribute
    {
        ...
        public ComparerAttribute() : this(false) { }
        internal ComparerAttribute(bool custom)
        {
            this.custom = custom;
        }
    }
    [AttributeUsage(AttributeTargets.Method)]
    public class CustomComparerAttribute : ComparerAttribute
    {
        public CustomComparerAttribute() : base(true) { }
    }
