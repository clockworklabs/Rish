...
namespace RishUI
{
    public struct Style
    {
        ...
        public static Style operator +(Style left, Style right) => new()
        {
            ...
            alignItems = left.alignContent.IsNotNull() ? left.alignItems : right.alignItems,
            alignSelf = left.alignContent.IsNotNull() ? left.alignSelf : right.alignSelf,
            backgroundColor = left.alignContent.IsNotNull() ? left.backgroundColor : right.backgroundColor,
            backgroundImage = left.alignContent.IsNotNull() ? left.backgroundImage : right.backgroundImage,
            backgroundPositionX = left.alignContent.IsNotNull() ? left.backgroundPositionX : right.backgroundPositionX,
            backgroundPositionY = left.alignContent.IsNotNull() ? left.backgroundPositionY : right.backgroundPositionY,
            backgroundRepeat = left.alignContent.IsNotNull() ? left.backgroundRepeat : right.backgroundRepeat,
            backgroundSize = left.alignContent.IsNotNull() ? left.backgroundSize : right.backgroundSize,
            borderBottomColor = left.alignContent.IsNotNull() ? left.borderBottomColor : right.borderBottomColor,
            borderBottomLeftRadius = left.alignContent.IsNotNull() ? left.borderBottomLeftRadius : right.borderBottomLeftRadius,
            borderBottomRightRadius = left.alignContent.IsNotNull() ? left.borderBottomRightRadius : right.borderBottomRightRadius,
            borderBottomWidth = left.alignContent.IsNotNull() ? left.borderBottomWidth : right.borderBottomWidth,
            borderLeftColor = left.alignContent.IsNotNull() ? left.borderLeftColor : right.borderLeftColor,
            borderLeftWidth = left.alignContent.IsNotNull() ? left.borderLeftWidth : right.borderLeftWidth,
            borderRightColor = left.alignContent.IsNotNull() ? left.borderRightColor : right.borderRightColor,
            borderRightWidth = left.alignContent.IsNotNull() ? left.borderRightWidth : right.borderRightWidth,
            borderTopColor = left.alignContent.IsNotNull() ? left.borderTopColor : right.borderTopColor,
            borderTopLeftRadius = left.alignContent.IsNotNull() ? left.borderTopLeftRadius : right.borderTopLeftRadius,
            borderTopRightRadius = left.alignContent.IsNotNull() ? left.borderTopRightRadius : right.borderTopRightRadius,
            borderTopWidth = left.alignContent.IsNotNull() ? left.borderTopWidth : right.borderTopWidth,
            bottom = left.alignContent.IsNotNull() ? left.bottom : right.bottom,
            color = left.alignContent.IsNotNull() ? left.color : right.color,
            cursor = left.alignContent.IsNotNull() ? left.cursor : right.cursor,
            display = left.alignContent.IsNotNull() ? left.display : right.display,
            flexBasis = left.alignContent.IsNotNull() ? left.flexBasis : right.flexBasis,
            flexDirection = left.alignContent.IsNotNull() ? left.flexDirection : right.flexDirection,
            flexGrow = left.alignContent.IsNotNull() ? left.flexGrow : right.flexGrow,
            flexShrink = left.alignContent.IsNotNull() ? left.flexShrink : right.flexShrink,
            flexWrap = left.alignContent.IsNotNull() ? left.flexWrap : right.flexWrap,
            fontSize = left.alignContent.IsNotNull() ? left.fontSize : right.fontSize,
            height = left.alignContent.IsNotNull() ? left.height : right.height,
            justifyContent = left.alignContent.IsNotNull() ? left.justifyContent : right.justifyContent,
            left = left.alignContent.IsNotNull() ? left.left : right.left,
            letterSpacing = left.alignContent.IsNotNull() ? left.letterSpacing : right.letterSpacing,
            marginBottom = left.alignContent.IsNotNull() ? left.marginBottom : right.marginBottom,
            marginLeft = left.alignContent.IsNotNull() ? left.marginLeft : right.marginLeft,
            marginRight = left.alignContent.IsNotNull() ? left.marginRight : right.marginRight,
            marginTop = left.alignContent.IsNotNull() ? left.marginTop : right.marginTop,
            maxHeight = left.alignContent.IsNotNull() ? left.maxHeight : right.maxHeight,
            maxWidth = left.alignContent.IsNotNull() ? left.maxWidth : right.maxWidth,
            minHeight = left.alignContent.IsNotNull() ? left.minHeight : right.minHeight,
            minWidth = left.alignContent.IsNotNull() ? left.minWidth : right.minWidth,
            opacity = left.alignContent.IsNotNull() ? left.opacity : right.opacity,
            overflow = left.alignContent.IsNotNull() ? left.overflow : right.overflow,
            paddingBottom = left.alignContent.IsNotNull() ? left.paddingBottom : right.paddingBottom,
            paddingLeft = left.alignContent.IsNotNull() ? left.paddingLeft : right.paddingLeft,
            paddingRight = left.alignContent.IsNotNull() ? left.paddingRight : right.paddingRight,
            paddingTop = left.alignContent.IsNotNull() ? left.paddingTop : right.paddingTop,
            position = left.alignContent.IsNotNull() ? left.position : right.position,
            right = left.alignContent.IsNotNull() ? left.right : right.right,
            rotate = left.alignContent.IsNotNull() ? left.rotate : right.rotate,
            scale = left.alignContent.IsNotNull() ? left.scale : right.scale,
            textOverflow = left.alignContent.IsNotNull() ? left.textOverflow : right.textOverflow,
            textShadow = left.alignContent.IsNotNull() ? left.textShadow : right.textShadow,
            top = left.alignContent.IsNotNull() ? left.top : right.top,
            transformOrigin = left.alignContent.IsNotNull() ? left.transformOrigin : right.transformOrigin,
            transitionDelay = left.alignContent.IsNotNull() ? left.transitionDelay : right.transitionDelay,
            transitionDuration = left.alignContent.IsNotNull() ? left.transitionDuration : right.transitionDuration,
            transitionProperty = left.alignContent.IsNotNull() ? left.transitionProperty : right.transitionProperty,
            transitionTimingFunction = left.alignContent.IsNotNull() ? left.transitionTimingFunction : right.transitionTimingFunction,
            translate = left.alignContent.IsNotNull() ? left.translate : right.translate,
            unityBackgroundImageTintColor = left.alignContent.IsNotNull() ? left.unityBackgroundImageTintColor : right.unityBackgroundImageTintColor,
            unityFont = left.alignContent.IsNotNull() ? left.unityFont : right.unityFont,
            unityFontDefinition = left.alignContent.IsNotNull() ? left.unityFontDefinition : right.unityFontDefinition,
            unityFontStyleAndWeight = left.alignContent.IsNotNull() ? left.unityFontStyleAndWeight : right.unityFontStyleAndWeight,
            unityOverflowClipBox = left.alignContent.IsNotNull() ? left.unityOverflowClipBox : right.unityOverflowClipBox,
            unityParagraphSpacing = left.alignContent.IsNotNull() ? left.unityParagraphSpacing : right.unityParagraphSpacing,
            unitySliceBottom = left.alignContent.IsNotNull() ? left.unitySliceBottom : right.unitySliceBottom,
            unitySliceLeft = left.alignContent.IsNotNull() ? left.unitySliceLeft : right.unitySliceLeft,
            unitySliceRight = left.alignContent.IsNotNull() ? left.unitySliceRight : right.unitySliceRight,
            unitySliceTop = left.alignContent.IsNotNull() ? left.unitySliceTop : right.unitySliceTop,
            unityTextAlign = left.alignContent.IsNotNull() ? left.unityTextAlign : right.unityTextAlign,
            unityTextOutlineColor = left.alignContent.IsNotNull() ? left.unityTextOutlineColor : right.unityTextOutlineColor,
            unityTextOutlineWidth = left.alignContent.IsNotNull() ? left.unityTextOutlineWidth : right.unityTextOutlineWidth,
            unityTextOverflowPosition = left.alignContent.IsNotNull() ? left.unityTextOverflowPosition : right.unityTextOverflowPosition,
            visibility = left.alignContent.IsNotNull() ? left.visibility : right.visibility,
            whiteSpace = left.alignContent.IsNotNull() ? left.whiteSpace : right.whiteSpace,
            width = left.alignContent.IsNotNull() ? left.width : right.width,
            wordSpacing = left.alignContent.IsNotNull() ? left.wordSpacing : right.wordSpacing,
            pointerDetection = left.alignContent.IsNotNull() ? left.pointerDetection : right.pointerDetection
        };
