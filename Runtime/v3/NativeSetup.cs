...
namespace RishUI.v3
{
    ...
    public delegate void NoPropsSetup<in T>(T element) where T : VisualElement;
    public delegate void PropsSetup<in T, in P>(T element, P props) where T : VisualElement where P : struct;
}